...
/*   Updated: 2024/09/11 19:50:29 by naadam           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	(void)t;
	w->cnv_img1 = mlx_xpm_file_to_image(w->mlx, "./textures/dali.xpm",
			&w->tex_w1, &w->tex_h1);
	w->cnv_img2 = mlx_xpm_file_to_image(w->mlx, "./textures/Judith.xpm",
			&w->tex_w2, &w->tex_h2);
	w->cnv_img3 = mlx_xpm_file_to_image(w->mlx, "./textures/Night.xpm",
			&w->tex_w3, &w->tex_h3);
	w->cnv_img4 = mlx_xpm_file_to_image(w->mlx, "./textures/Pearl.xpm",
			&w->tex_w4, &w->tex_h4);
}
